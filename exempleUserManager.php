...
$table->setFieldsAtive("id, nome, login, email, ativo", 'ver');
$table->setCampoPass("senha",0, "md5");
$table->setFieldsAtive("nome, login, pass, email, tipo, ativo", 'novo');
$table->setFieldsAtive("nome, login, pass, email, tipo, ativo", 'csv');
$table->setFieldsAtive("nome, login, pass, email, tipo, ativo", 'editar');

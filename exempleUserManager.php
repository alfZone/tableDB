...
//			see page with to styles url?id=keyValue ou url/keyValue
...
// setLinkPage($page,$style=0) | setPaginaVer($page,$style=0) - Stores the name of the page that should be opened to show the record where the page is the address for an html page for the record and
//								$style is the Style of the way a key value are passed. if style=0 then the url to see is url?id=keyValue. if style=1 then the url is url/keyValue
...
//###################################################################################################################################	
  ...
  //###################################################################################################################################
	...
	* @param $style   Style of the way a key value are passed. if style=0 then the url to see is url?id=keyValue. if style=1 then the url 
	*				  is url/keyValue
	*
